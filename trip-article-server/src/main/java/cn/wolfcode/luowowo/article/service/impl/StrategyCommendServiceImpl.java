...
public class StrategyCommendServiceImpl implements IStrategyCommendService {
    ...
    @Override
    public List<StrategyCommend> list() {
        return strategyCommendMapper.selectAll();
    }

    @Override
    public StrategyCommend get(Long sid) {
        return strategyCommendMapper.selectByPrimaryKey(sid);
    }

    @Override
    public void deleteById(long id) {
        strategyCommendMapper.deleteByPrimaryKey(id);
    }

    @Override
    public List<StrategyCommend> queryTop(int num) {
        return strategyCommendMapper.selectTop(num);
    }
}
