...
public class TravelCommendServiceImpl implements ITravelCommendService {
    ...
    @Override
    public List<TravelCommend> list() {
        return travelCommendMapper.selectAll();
    }

    @Override
    public TravelCommend get(Long sid) {
        return travelCommendMapper.selectByPrimaryKey(sid);
    }
    ...
    @Override
    public List<TravelCommend> queryTop(int num) {
        return travelCommendMapper.selectTop(num);
    }
}
