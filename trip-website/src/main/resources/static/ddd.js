...
;
(function(){if(!window.MFWMA){var h={parseUrl:function(a){var b=(a||"").split("#");a=b[1];b=b[0].split("?");var d=b[0];b=b[1];var f=(d.split("/")[2]||"").split(".").slice(-2).join(".");return{hash:a,uri:d,queryStr:b,mainHost:f}},getParameter:function(a,b){var d=new RegExp("(^"+b+"=([^&]*))|(&"+b+"=[^&]*)","g");a=a||"";"?"===a[0]&&(a=a.substring(1));if(d=a.match(d)){var f=d[d.length-1];f=f.substring("&"==f[0]?b.length+2:b.length+1)}return f},lazyJump:function(a){a!=location.href&&("function"==typeof history.replaceState?
            (e("replace state",a),history.replaceState(null,null,a)):(e("replace url",a),location.replace(a)))},syncParameter:function(a,b,d,f){b=h.parseUrl(b);var c=h.parseUrl(a),k,e;f="function"==typeof f?f:function(){};for(var g=0;g<d.length,k=d[g];g++)if((e=h.getParameter(b.queryStr,k))&&!1!==f(k,e,c,b)){var l=h.getParameter(c.queryStr,k);l||(c.queryStr=c.queryStr||"",c.queryStr=void 0==l?c.queryStr+((c.queryStr?"&":"")+k+"="+e):c.queryStr.replace(k+"="+l,k+"="+e),a=c.uri+"?"+c.queryStr+(void 0!==c.hash?
            "#"+c.hash:""))}return a}},e=function(){n&&"object"==typeof console&&console.log.apply(null,arguments)},l=function(){n&&"object"==typeof console&&console.warn.apply(null,arguments)},n=!1,c={},p=navigator.userAgent;p.match(/miniprogram/i)||"miniprogram"===window.__wxjs_environment?c.platform="wx":p.match(/swan\//i)&&(c.platform="swan");if(c.platform)try{var r=h.syncParameter(location.href,document.referrer,["_sFromMA"],function(a,b,d,c){if(d.mainHost!==c.mainHost)return!1});h.lazyJump(r);var g=h.getParameter(location.search,
        "_sFromMA");g&&(g=g.split("_"))&&g[0]==c.platform&&(c.appid=g[1]);c.appid&&document.addEventListener("click",function(a){a=a.target;for(var b,d;a;){if(a.tagName&&"a"===a.tagName.toLowerCase()){b=a;break}a=a.parentNode}b&&(d=b.getAttribute("href"))&&0!==d.indexOf("#")&&0!==d.indexOf("javascript:")&&(a=h.syncParameter(d,location.href,["_sFromMA"],function(a,b,d,c){if(d.mainHost&&d.mainHost!==c.mainHost)return!1}),a!=d&&(e(d,a),b.setAttribute("href",a),!b.getAttribute("_ma_init_href")&&b.setAttribute("_ma_init_href",
        d)))},!1)}catch(a){l("Env init error",a)}var t=function(){var a={};return function(b,d){a[b]=a[b]||{loadingStatus:0,callbacks:[]};if(2==a[b].loadingStatus)d();else if(0==a[b].loadingStatus){a[b].loadingStatus=1;a[b].callbacks.push(d);e(b+" loading");var c=document.createElement("script");c.type="text/javascript";c.charset="utf-8";c.async=!0;c.onerror=function(c){a[b].loadingStatus=3;l(b+" load error",c)};c.onload=function(){a[b].loadingStatus=2;e(b+" load success");a[b].callbacks.forEach(function(a){a()})};
    c.src=b;document.head.appendChild(c)}else 1==a[b].loadingStatus&&a[b].callbacks.push(d)}}(),q={wx:"https://res.wx.qq.com/open/js/jweixin-1.4.0.js",swan:"https://b.bdstatic.com/searchbox/icms/searchbox/js/swan-2.0.18.js"},m=function(a){c.platform&&(window[c.platform]?a(c):q[c.platform]&&t(q[c.platform],function(){a(c)}))};m(function(){e(c)});window.MFWMA={getEnv:function(a){"function"==typeof a&&a(c)},invoke:function(){var a=[],b;if(0<arguments.length){var d=arguments[0];a=Array.prototype.slice.call(arguments,
            1);e("invoke "+d,a);"string"==typeof d&&(d=d.split("."))&&m(function(){if(b=window[c.platform])2==d.length?("swan"==c.platform&&"miniProgram"==d[0]&&(d[0]="webView"),(b=b[d[0]])&&(b=b[d[1]])):b=b[d[0]],b?b.apply(null,a):l(c.platform+"."+d.join(".")+" not supported")})}},apiReady:m}}})();;
/**
