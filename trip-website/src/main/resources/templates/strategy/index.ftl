...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="gl_wrap">
            ...
            <#list abroads as c>
                   <li>
                       <a href="javascript:;" class="strategySearch " data-type="0"  data-value="${c.id!}">${c.name!}(${c.count!})</a>
                   </li>
               </#list>
            </ol>
            <span class="sp_toggle">
        ...
        <div class="gl_wrap">
            ...
            <ol>
              <#list themes as t>
                    <li>
                        <a href="javascript:;" class="strategySearch"  data-type="2" data-value="${t.id!}">${t.name!}(${t.count!})</a>
                    </li>
                </#list>
            </ol>
            <span class="sp_toggle">
