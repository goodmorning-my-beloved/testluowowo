        ...
        <div class="main_box">
            ...
            <div class="main_content_box main_recommend clearfix">
                <ul class="recommend_tab_t">
                    <li class="city_js active" data="229" data2="">广州</li>
                ...
                <div class="recommend_list_content" style="display: block;">
                    <div class="main_content_l ticket_icon">
                        <ul class="recommend_tab_l">
                            <li class="active subject_js" data="5">主题乐园<i class="ticket_icon"></i></li>
                            ...
                            <#list tickets as ticket>
                                ...
                                <li>
                                    <a href="/ticket/detail?tid=${ticket.id}" target="_blank" onclick="cmcTag('门票频道页-PC-站点-P4-景点推荐-广州主题乐园-001-广州塔','PC门票频道页景点推荐');">
                                        <div class="promotion_img_box">
                                            <img src="${(ticket.coverImgUrl)!}" width="222" height="150" alt="">
                                        </div>
                                        <div class="promotion_footer">
                                            <h5 title="广州塔">${(ticket.title)!}</h5>
